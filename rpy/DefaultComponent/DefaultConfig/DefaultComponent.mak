...
Foo.obj : Foo.cpp Foo.h    Default.h intFlowInterface.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Foo.obj" "Foo.cpp" 



Bar.obj : Bar.cpp Bar.h    Default.h intFlowInterface.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Bar.obj" "Bar.cpp" 



intFlowInterface.obj : intFlowInterface.cpp intFlowInterface.h    
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"intFlowInterface.obj" "intFlowInterface.cpp" 



Default.obj : Default.cpp Default.h    Foo.h Bar.h 
	$(CREATE_OBJ_DIR)
...
clean:
	@echo Cleanup
	if exist Foo.obj erase Foo.obj
	if exist Bar.obj erase Bar.obj
